url: https://raw.githubusercontent.com/NeonTechno/ai-orchestrator-agent/main/api/server.py
...
def clear_history(provider: str = "anthropic"):
    ...
    return {"message": f"Conversation history cleared
 for provider={provider!r}"}
